...
#add constants next
admins = {'Faculty1':'ABC123','Faculty2':'ABC123','Jada': 'Wood'}
...
def average_students():
     '''
      Funtion to average all students' grades.
      '''
     for student in students:
        grades = students[student]
        average = s.mean(grades) #notice the s? we imported the statistuics module as s.
